...
def CreateCrawlerViewLayout():
    ...
    _RECURSIVE_CRAWL_SELECTOR = [sg.Text('No of pages to crawl through: '), sg.Spin([i for i in range(1,101)], initial_value=15, key=RECURSIVE_CRAWL_TIMES_KEY, readonly=True)]
